...
class Motor extends CI_Controller {
	...
	public function index()
	{
		...
		$data['lokasi'] = $this->LokasiModel->getAllLokasi()->result();
	...
	public function order()
	{
        ...
        $exe 			= $this->motor->order($customerId, $driverId, $from, $to, $price, $jarak, );
	...
	public function orderBatal()
	{
        ...
        $exe 			= $this->motor->orderBatal($customerId, $driverId, $from, $to, $price, $jarak, );
