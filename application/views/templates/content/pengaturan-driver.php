  ...
  <div class="content clearfix">
		...
		<div id="colors" class="container mb-5">
			...
			<div class="section-title col-lg-8 col-md-10 ml-auto mr-auto text-center">
			  <h3 class="mb-4 text-uppercase">Setting Driver</h3>
      		...
      		<form role="form" id="form" method="post">
	        	<div class="modal-body">
					...
					<div class="row">
	        			<div class="col-md-12">
	          				<div class="form-group">
	            				<label for="tanggal">Kendaraan </label>
...
<script type="text/javascript">
	...
	{
		$.ajax({
			url: '<?= base_url() ?>pengaturan/Driver/getAllData',
			method: 'post',
			data: null,
			dataType: 'json',
			success(data)
			{
	            ...
	            for (i = 0; i < data.length; i++)
	            {
	            	...
	            	html += 
						...
						'<td>'+ data[i].user_kendaraan +'</td>'+
						'<td>'+ data[i].user_ktp +'</td>'+
	...
	function edit(id)
	{
		...
		$.ajax({
			...
			success(data)
			{
				...
				$('#kendaran').val(data.user_kendaraan)
				$('#ktp').val(data.user_ktp)
